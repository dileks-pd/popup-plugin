		...
		<div class="holder">
			<div class="frame">
				<div class="setting-block">
					<div class="row">
						<strong>
							<label for="vertical-length"><?php _e( 'Border Style', 'smile' ); ?></label>
						</strong>
				...
				?>
					...
					<div class="row bordercolor-block">
						...
						<div class="text-2">
							<input id="br-color" class="cs-wp-color-picker " data-default-color="<?php echo esc_attr( $border_color ); ?>" type="text" value="<?php echo $border_color; ?>">
						</div>
					</div>
				</div>
						...
						?>
							...
							<div class="setting-block radius-block">
								<div class="row">
									...
									<div class="text-1">
										<input id="all-corners" class="sm-small-inputs" type="number" min="0" value="<?php echo $all_corners; ?>">
									</div>
								</div>
						...
						?>
							...
							<div class="setting-block">
								<div class="row">
									...
									<div class="text-1">
										<input id="top-left" class="sm-small-inputs" type="number" min="0" value="<?php echo $top_left; ?>">
									</div>
								</div>
								...
								<div class="row mtop15">
									...
									<div class="text-1">
										<input id="top-right" class="sm-small-inputs" type="number" min="0" value="<?php echo $top_right; ?>">
									</div>
								</div>
								...
								<div class="row mtop15">
									...
									<div class="text-1">
										<input id="bottom-left" class="sm-small-inputs" type="number" min="0" value="<?php echo $bottom_left; ?>">
									</div>
								</div>
								...
								<div class="row mtop15">
									...
									<div class="text-1">
										<input id="bottom-right" class="sm-small-inputs" type="number" min="0" value="<?php echo $bottom_right; ?>">
									</div>
								</div>
