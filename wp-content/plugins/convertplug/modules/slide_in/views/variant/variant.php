...
if ( 0 < count( $variants ) ) {
	$analytics_link = '?page=smile-slide_in-designer&style-view=analytics&compFactor=' . $comp_factor . '&style=' . urlencode( $style_for_analytics );
}
?>
...
<div class="wrap about-wrap bend cp-slidein-main">
	<div class="wrap-container">
		<div class="bend-heading-section">
			...
			<a href="<?php echo $analytics_link; ?>"  style="margin-right: 25px !important;" class="bsf-connect-download-csv"><i class="connects-icon-bar-graph-2" style="line-height: 30px;"></i>
